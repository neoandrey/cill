   ...
   grunt.initConfig({
      ...
      copy: {
         main: {
            ...
            files: [
               ...
               , { src: ['app/static/dist/js/custom/juicetoolkit.js'], dest: 'app/dist/static/js/custom/juicetoolkit.js' }
      ...
      cssmin: {
         target: {
            files: [{
               ...
               dest: 'app/dist/static/css/juice-css.css'
            }]
         }
      }
      ,
      uglify: {
         options: {
            ...
            , sourceMap: true
            , compress: true
            , sourceMapPrefix: "app/staging/dist/js/juice-sourcemap-1"
         ...
         target: {
            ...
            dest: 'app/dist/static/js/juice-splmt-lib.min.js'
         ...
         build: {
            ...
            , dest: 'app/dist/static/js/juice-core-lib.js'
         }
      }
   });
